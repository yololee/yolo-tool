...
public class FileHandleUtil {
    ...
    public static String writeImportBytes(byte[] data) throws IOException {
        return writeBytes(data, UploadProperties.getImportPath());
    }
    ...
    public static String writeBytes(byte[] data, String uploadDir) throws IOException {
        ...
        try {
            ...
            pathName = FileUploadUtil.datePath() + "/" + UUID.randomUUID().toString().replaceAll("-", "") + "." + extension;
    ...
    public static String setFileDownloadHeader(HttpServletRequest request, String fileName) throws UnsupportedEncodingException {
        ...
        if (agent.contains("MSIE")) {
            // IE浏览器
            filename = URLEncoder.encode(filename, Charsets.UTF_8_NAME);
            filename = filename.replace("+", " ");
        } else if (agent.contains("Firefox")) {
            // 火狐浏览器
            filename = new String(fileName.getBytes(), Charsets.ISO_8859_1_NAME);
    ...
    /**
     * 获取文件名称 /profile/upload/2022/04/16/yolo.png -- yolo.png
     *
     * @param fileName 路径名称
     * @return 没有文件路径的名称
     */
    ...
    /**
     * 获取不带后缀文件名称 /profile/upload/2022/04/16/yolo.png -- yolo
     *
     * @param fileName 路径名称
     * @return 没有文件路径和后缀的名称
     */
