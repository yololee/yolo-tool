...
@Data
public class YoloSystemConstant {
     ...
     * 上传下载路径(物理路径)
     */
    private String remotePath = System.getProperty("user.dir") + "/target/yolo";
    ...
    private static final YoloSystemConstant ME = new YoloSystemConstant();

    private YoloSystemConstant() {

    }

    public static YoloSystemConstant me() {
        return ME;
    }
