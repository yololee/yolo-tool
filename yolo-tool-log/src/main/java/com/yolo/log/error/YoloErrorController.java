 ...
 * 更改html请求异常为ajax
 */
public class YoloErrorController extends BasicErrorController {

	public YoloErrorController(ErrorAttributes errorAttributes, ErrorProperties errorProperties) {
