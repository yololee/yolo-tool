package com.yolo.log.logger;

import com.yolo.log.publisher.UsualLogPublisher;
 ...
 */
@Slf4j
public class YoloLogger implements InitializingBean {
	...
	public void afterPropertiesSet() throws Exception {
		log.info(serviceId + ": YoloLogger init success!");
	}
