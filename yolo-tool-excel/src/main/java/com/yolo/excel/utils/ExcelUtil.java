...
import com.yolo.excel.DefaultExcelListener;
import com.yolo.excel.ExcelListener;
import com.yolo.excel.ExcelResult;
import com.yolo.excel.convert.ExcelBigNumberConvert;
import com.yolo.excel.strategy.CellMergeStrategy;
import com.yolo.excel.strategy.DropDownOptions;
import com.yolo.excel.strategy.ExcelDownHandler;
...
public class ExcelUtil {
    ...
    public static void exportTemplateMultiList(Map<String, Object> data, String templatePath, OutputStream os) {
        ClassPathResource templateResource = new ClassPathResource(templatePath);
        ExcelWriter excelWriter = EasyExcelFactory.write(os)
            .withTemplate(templateResource.getStream())
            .autoCloseStream(false)
            // 大数值自动转换 防止失真
            .registerConverter(new ExcelBigNumberConvert())
