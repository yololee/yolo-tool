...
public class RedisCache {
	 ...
	 */
	@Nullable
	public Long bitCount(String key, long start, long end, com.yolo.redis.cache.RedisCommand.BitMapModel model) {
		return redisTemplate.execute((RedisCallback<Long>) redis ->
			(Long) redis.execute(com.yolo.redis.cache.RedisCommand.BITCOUNT, keySerialize(key),
