package com.yolo.tool.support.logger;

import com.yolo.tool.constant.AppConstant;
...
import com.yolo.tool.support.utils.web.WebUtil;
...
public class RequestLogAspect {
	 ...
	 */
	@Around(
		"execution(!static com.yolo.tool.api.R *(..)) && " +
